...
class DocumentRiskService:
    ...
    RULE_CODE_TO_RISK_KEY = {
        ...
        "FIN_DATA_REVENUE_VOLATILITY": "financial_revenue_volatility",
        "FIN_DATA_PROFIT_CASH_MISMATCH": "financial_profit_cash_mismatch",
        "FIN_DATA_MARGIN_DECLINE": "financial_margin_decline",
        "FIN_DATA_LEVERAGE_PRESSURE": "financial_leverage_pressure",
        "FIN_DATA_DEDUCT_PROFIT_DEPENDENCE": "financial_deduct_profit_dependence",
        "FIN_DATA_AR_TURNOVER_DECLINE": "financial_ar_turnover_decline",
        "FIN_DATA_INVENTORY_TURNOVER_DECLINE": "financial_inventory_turnover_decline",
        "FIN_DATA_INTEREST_DEBT_PRESSURE": "financial_interest_debt_pressure",
        "FIN_DATA_EXPENSE_RATIO_INCREASE": "financial_expense_ratio_increase",
        "FIN_DATA_FIXED_ASSET_VOLATILITY": "financial_fixed_asset_volatility",
        "FIN_DATA_INDUSTRY_DEVIATION": "financial_industry_deviation",
    }
    RISK_TITLES = {
        ...
        "financial_revenue_volatility": "收入波动异常风险",
        "financial_profit_cash_mismatch": "利润现金错配风险",
        "financial_margin_decline": "利润率下滑风险",
        "financial_leverage_pressure": "杠杆压力风险",
        "financial_deduct_profit_dependence": "扣非利润偏低风险",
        "financial_ar_turnover_decline": "应收账款周转放缓风险",
        "financial_inventory_turnover_decline": "存货周转放缓风险",
        "financial_interest_debt_pressure": "有息负债压力风险",
        "financial_expense_ratio_increase": "期间费用率上升风险",
        "financial_fixed_asset_volatility": "固定资产异常波动风险",
        "financial_industry_deviation": "行业对比偏离风险",
